...
const alia = result(95);
const dalia = result(66);
const salia = result(80);
const malia = result(59);
const lilia = result(47);
const jalaiya = result(77);

console.log('Alia:', alia, ', Dalia:', dalia, ', Salia:', salia, ', Malia:', malia, ', Lilia:', lilia, ', Jalaiya:', jalaiya)
...
const c1 = trafficSignal('red')
const c2 = trafficSignal('yellow')
const c3 = trafficSignal('green')
